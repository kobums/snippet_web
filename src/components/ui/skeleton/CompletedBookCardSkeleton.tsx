  ...
  return (
    <>
      {Array.from({ length: count }).map((_, i) => (
        <div key={i} className="bg-white/60 border border-white/60 rounded-2xl overflow-hidden shadow-sm">
          {/* 커버 영역 */}
          <div className="w-full h-[180px] sm:h-[200px] bg-gray-50 flex items-center justify-center p-3 sm:p-4">
            <div className="w-24 h-36 bg-gray-100 rounded-md animate-pulse" />
          </div>
          ...
          <div className="px-3 sm:px-4 py-2.5 sm:py-3 flex flex-col gap-1.5">
            ...
            {/* 저자 */}
            <div className="h-3 w-1/2 bg-gray-100 rounded animate-pulse pl-5" />
